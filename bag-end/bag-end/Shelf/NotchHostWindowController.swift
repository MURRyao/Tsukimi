...
private struct NotchHostView: View {
    ...
    private var compactIsland: some View {
        VStack(spacing: 4) {
            ...
            .frame(width: compactWidth, height: BagEndDesign.Shelf.notchHeight)
            .background(
    ...
    private var compactWidth: CGFloat {
        ...
        case .closed:
            return BagEndDesign.Shelf.notchWidth
        case .peeking:
            return BagEndDesign.Shelf.handleWidth
        case .dragTarget:
            return BagEndDesign.Shelf.handleWidth + 34
        case .expanded:
            return BagEndDesign.Shelf.handleWidth
        }
    }
    ...
    private var statusColor: Color {
        model.presentation == .dragTarget ? .white : BagEndDesign.ColorToken.brandAccent
    }
}
