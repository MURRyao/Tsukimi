...
enum BagEndShortcut: CaseIterable, Identifiable {
    case captureArea
    case toggleShelf
...
struct GlobalHotKeyRegistration {
    let shortcut: BagEndShortcut
    let action: () -> Void
}

enum GlobalHotKeyError: Error {
    case handlerInstallFailed(OSStatus)
    case registrationFailed(BagEndShortcut, OSStatus)
}

final class GlobalHotKeyService {
    private static let signature = fourCharCode("BEND")
